...
- [ ] simplify PR templates to also use `/show-me` by humanlayer, describe changes in pseudocode, evidence of TDD
- [ ] `/improve-codebase-architecture restructure effect app folder/structure for deep modules, seams, adapters`
